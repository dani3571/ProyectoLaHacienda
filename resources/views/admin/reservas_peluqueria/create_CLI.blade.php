...
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{route('reservas_peluqueria.store_CLI')}}" >
            @csrf 
            
            <div class="form-group">
                <input type="hidden" class="form-control" id="usuario_id" name='usuario_id' value="{{  $user->id  }}">
            </div>
            ...
            <a class="btn btn-danger" href="{{route('reservas_peluqueria.reservas_CLI')}}">Volver</a>
     </form>
    </div>
</div>
@endsection
